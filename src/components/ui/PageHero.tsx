...
export function PageHero({
  ...
  return (
    <section className="relative overflow-hidden bg-[#020416] px-4 pb-20 pt-36 text-white">
      ...
      <div className="relative mx-auto max-w-5xl text-center">
        ...
        <h1 className="mt-5 text-4xl font-black uppercase tracking-normal sm:text-6xl">
          {title}
        </h1>
