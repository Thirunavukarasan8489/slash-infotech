...
export const metadata: Metadata = { title: "Blog", description: "Software, AI, cloud, and design insights from Slash Infotech.", openGraph: { title: "Blog | Slash Infotech", description: "Industry insights from Slash Infotech.", images: ["/images/og-image.png"], url: "https://slash-infotech.vercel.app/blog" } };
