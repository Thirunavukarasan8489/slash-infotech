  ...
  return (
    <section className="relative flex min-h-screen items-center overflow-hidden bg-[#111827] px-4 pt-28 text-white">
      ...
      {[...Array(18)].map((_, index) => (
        <motion.span
          key={index}
          className="absolute h-2 w-2 rounded-sm bg-[#2563EB]/50"
          style={{
            left: `${(index * 17) % 100}%`,
            top: `${18 + ((index * 23) % 70)}%`,
          }}
      ...
      <div className="relative mx-auto grid w-full max-w-7xl items-center gap-12 lg:grid-cols-[1.05fr_0.95fr]">
        ...
        >
          <motion.p
            ...
            className="font-mono text-sm font-bold uppercase tracking-[0.35em] text-[#93C5FD]"
          >
          ...
          <motion.h1
            ...
            className="mt-5 max-w-4xl text-5xl font-black uppercase leading-[0.95] tracking-normal sm:text-6xl lg:text-7xl"
          >
            Build sharper software with AI, cloud, and design.
          </motion.h1>
          <motion.p
            variants={{
              hidden: { opacity: 0, y: 24 },
          ...
          >
            Slash Infotech partners with ambitious teams to design, engineer,
            and scale premium digital products across web, mobile, AI, cloud,
            and security.
          </motion.p>
          <motion.div
            variants={{
        ...
        >
          ...
          <motion.div
            ...
            className="absolute inset-20 rounded-full border-dashed border-2 border-[#2563EB]/50"
          />
          <div className="absolute inset-0 grid place-items-center font-black text-white drop-shadow-[0_0_40px_rgba(37,99,235,0.55)]">
            <Image
