...
export const teamMembers = [
  ...
  },
  {
    ...
    bio: "Kasthuri leads engineering delivery, full-stack architecture, and quality standards across web platforms, APIs, and internal systems.",
  ...
  },
  {
    ...
    bio: "Thirunavukarasan guides client relationships, delivery coordination, and user-focused product decisions from concept to launch.",
