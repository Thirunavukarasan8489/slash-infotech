...
export const metadata: Metadata = {
  title: "Cookie Policy",
  description:
    "Cookie information for the Slash Infotech website, including essential and analytics cookies.",
  openGraph: {
    title: "Cookie Policy | Slash Infotech",
    description:
      "Cookie information for the Slash Infotech website, including essential and analytics cookies.",
    images: ["/images/og-image.png"],
    url: "https://slash-infotech.vercel.app/cookies",
  },
  icons: {
    icon: "/favicon.ico",
  ...
  return (
    <>
      <PageHero
        eyebrow="Legal"
        title="Cookie Policy"
        text="Cookie information for the Slash Infotech website, including essential and analytics cookies."
      />
